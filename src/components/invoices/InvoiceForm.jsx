...
export default function InvoiceForm({onCancel, onInvoiceCreated}) {
    ...
    const grandTotal = useMemo(
        () => subtotal + (subtotal * Number(gstRate || 0)) / 100,
        [subtotal, gstRate]
    );
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                ...
                                <input
                                    ...
                                    onChange={(event) => setBillingTo((prev) => ({...prev, phone: event.target.value}))}
                                    className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-slate-900 outline-none focus:border-blue-500"
                                    placeholder="Phone"
                                />
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                ...
                                <input
                                    ...
                                    onChange={(event) => setShippingTo((prev) => ({...prev, phone: event.target.value}))}
                                    className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-slate-900 outline-none focus:border-blue-500"
                                    placeholder="Phone"
                                />
                            </div>
                ...
                <section className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-4 flex items-center justify-between gap-3">
                        <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Product Items</h3>
                        <button
                            type="button"
                            onClick={addItemRow}
                                        ...
                                        <tr key={item.id} className="border-t border-slate-200 align-top">
                                            ...
                                            <td className="py-3 pr-3">
                                                <input
                                                    ...
                                                    className="w-24 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-slate-900 outline-none focus:border-blue-500"
                                                />
                                            </td>
                                            <td className="py-3 pr-3">
                                                <input
                                                    ...
                                                    className="w-28 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-slate-900 outline-none focus:border-blue-500"
                                                />
                                            </td>
